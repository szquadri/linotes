...
dnf install wget mc strace lsof sysstat dstat hdparm htop iftop atop perf iperf iptraf nc socat mtr jwhois mutt elinks psacct powertop tmux screen pgpdump -y
