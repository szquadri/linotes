...
dnf install glibc.x86_64 glibc-devel.x86_64 libstdc++.x86_64 zlib-devel.x86_64 ncurses-devel.x86_64 libX11-devel.x86_64 libXrender.x86_64 libXrandr.x86_64 -y-y
